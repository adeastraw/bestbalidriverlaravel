                    ...
                    @forelse($trips as $trip)
                        <tr class="hover:bg-cream-50 transition-colors">
                            <td class="p-4 flex items-center gap-3">
                                <img src="{{ $trip->hero_image_url }}" alt="{{ $trip->name }}" class="w-12 h-10 rounded-lg object-cover">
                                <div>
                            ...
                            <td class="p-4 text-sand-700 text-xs">{{ $trip->category ?: 'Day Tour' }}</td>
                            ...
                            <td class="p-4 text-right space-x-2">
                                <a href="{{ route('trips.show', $trip->slug) }}" target="_blank" class="text-xs font-semibold text-sand-600 hover:underline">
                                    View
                                </a>
